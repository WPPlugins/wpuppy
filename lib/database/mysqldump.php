...
class CompressWordpress extends CompressManagerFactory
{
    ...
    public function close()
    {
        ...
        $basepath = $wp_filesystem->abspath();
        if(!$wp_filesystem->put_contents($basepath . $this->filename, $this->data, FS_CHMOD_FILE))
            throw new Exception("Failed to write {$this->filename}");
